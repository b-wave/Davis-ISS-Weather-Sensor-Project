/**
 * AS5048A.cpp — AS5048A Magnetic Angle Sensor Implementation
 *
 * ISS Packet Engine — Sensor Driver Architecture
 *
 * I2C register reads for 14-bit absolute angle. The AS5048A provides
...
String AS5048A::getDiagnostic()
{
	...
	{
		return "CORDIC overflow no magnet";
	}
