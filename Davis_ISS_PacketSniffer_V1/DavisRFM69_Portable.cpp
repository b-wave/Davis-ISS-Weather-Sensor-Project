...
//moved here to fix compiler warning
const FRF_ITEM *bandTab[4] = {
    FRF_US,
    FRF_AU,
    FRF_EU,
    FRF_NZ
...
const uint8_t bandTabLengths[4] = {
...
void DavisRFM69::setChannel(byte channel)
{
  ...
  byte a = bandTab[band][CHANNEL][0];
  byte b = bandTab[band][CHANNEL][1];
  byte c = bandTab[band][CHANNEL][2];
...
void DavisRFM69::setFreqCorr(int16_t value)
{
