...
#ifndef DAVISRFM69_PORTABLE_H
#define DAVISRFM69_PORTABLE_H
...
#ifndef RF69_IRQ_PIN
#define RF69_IRQ_PIN 2    //set for Teensy change in program
#endif

#ifndef RF69_IRQ_NUM
#define RF69_IRQ_NUM 2  //set for Teensy change in program
#endif
...
static const   FRF_ITEM FRF_US[FREQ_TABLE_LENGTH_US] =
{
  {0xE3, 0xDA, 0x7C},
  {0xE1, 0x98, 0x71},
  {0xE3, 0xFA, 0x92},
...
static const   FRF_ITEM FRF_AU[FREQ_TABLE_LENGTH_AU] =
{
   {0xE5, 0x84, 0xDD},
   {0xE6, 0x43, 0x43},
   {0xE7, 0x1F, 0xCE},
...
static const   FRF_ITEM FRF_EU[FREQ_TABLE_LENGTH_EU] =
{
  {0xD9, 0x04, 0x45},
  {0xD9, 0x13, 0x04},
  {0xD9, 0x21, 0xC2},
...
static const   FRF_ITEM FRF_NZ[FREQ_TABLE_LENGTH_NZ] =
{
  {0xE6, 0x45, 0x0E},
  {0xE7, 0x43, 0xC7},
  {0xE6, 0xF4, 0xAC},
...
*/
extern const FRF_ITEM *bandTab[4];
extern const uint8_t bandTabLengths[4];
